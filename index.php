...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    header("location: search-result.php?cat=" . $category . "&search=" . $search);
}
?>
<html>
  <head>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" >
        <div class="inner-form">
          ...
          <div class="input-field second-wrap">
            <input id="search" type="text" placeholder="Enter Info" name="search" id="search" value="<?php echo $search; ?>"/>
          </div>
